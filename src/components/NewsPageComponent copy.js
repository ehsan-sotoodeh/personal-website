        ...
        <li className="wow fadeInUp" data-wow-duration="1.2s">
          <div className="inner_list">
            <div className="image_wrap">
              <img className="small" src="https://raelyntan.com/wp-content/uploads/2018/06/top-blogger-quotes-hori-1.png" alt="" />
              <img className="big" src="https://raelyntan.com/wp-content/uploads/2018/06/top-blogger-quotes-hori-1.png" alt="" />
              <div className="news_image" data-url="https://raelyntan.com/wp-content/uploads/2018/06/top-blogger-quotes-hori-1.png"></div>
